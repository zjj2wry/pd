...
func shouldBalance(cluster schedule.Cluster, source, target *core.StoreInfo, region *core.RegionInfo, kind core.ScheduleKind, opInfluence schedule.OpInfluence, scheduleName string) bool {
...
func getTolerantResource(cluster schedule.Cluster, region *core.RegionInfo, kind core.ScheduleKind) int64 {
